...
import { FiUsers, FiShield, FiGrid } from 'react-icons/fi';
...
const EmployeeDashboard = () => {
  ...
  const features = [
    {
      title: 'List All Consumers',
      description: 'View and manage all consumer accounts.',
      link: '/employee/listConsumer',
    ...
    <div className="min-h-screen bg-slate-100 font-sans">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <header className="mb-10 text-center">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-800">Employee Dashboard</h1>
          <p className="mt-2 text-lg text-gray-500">Your central hub for managing policies and consumers.</p>
        </header>
